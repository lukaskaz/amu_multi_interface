...
private:
    ...
    void collectData(void) {
        ...
        ipc_data.type = IPC_DATA_WEB;
        ipc_data.web.request_nb = ++request_nb;
        ipc_data.web.nick = custom_stream.mapGetValue("nick", "N/A");
        ipc_data.web.name = custom_stream.mapGetValue("name", "N/A");

        custom_stream.listAddEntry("Name: ", ipc_data.web.name);
        custom_stream.listAddEntry("Nick: ", ipc_data.web.nick);
