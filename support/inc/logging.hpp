...
public:
    ...
    void log(const std::string &txt) { log_simple("", txt); };
...
private:
    ...
    void log_simple(const std::string &source, const std::string &txt);
    void log_error(const std::string &source, const std::string &txt);
    void log_info(const std::string &source, const std::string &txt);
    void log_debug(const std::string &source, const std::string &txt);
};
